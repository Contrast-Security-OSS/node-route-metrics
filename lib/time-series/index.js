    ...
    const intervalHandler = () => {
      ...
      if (delta >= this.averagingInterval) {
        ...
        const cpuAndMem = {
          ...
          heapUsedAvg: mem.heapUsed, //this.memHeapUsedEMA.update(mem.heapUsed),
          externalAvg: mem.external, //this.memExternalEMA.update(mem.external),
