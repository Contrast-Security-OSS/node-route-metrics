...
export default class LogProcessor {
  constructor(file, reporter, stream, options = {}) {
    ...
    // these are used by the deprecated log processors (csv-deprecated,
    // json-deprecated). they exist only for testing at this point.
    this.summaries = [];
    // this is used by the current log processor implementations (csv, json).
  ...
  async processFile() {
    ...
    this.rmr.indexArray(this.summary.lines);
    this.routeMetricsResults.push(this.rmr);
    ...
    return this.inputStream.bytesRead;
  }
