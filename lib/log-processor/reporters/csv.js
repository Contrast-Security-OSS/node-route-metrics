...
function writeInformation(s, meta) {
  /* eslint-disable no-console */
  const {linesRead, charCount} = meta.overallInfo;
  console.log(`[read ${linesRead} lines (${charCount} chars)]`);
