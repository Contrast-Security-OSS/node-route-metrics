...
const {patcher, emitter} = require('../lib/patcher');
...
describe('patcher', function() {
  ...
  it('emits errors and returns unmodified module when patching fails', function() {
    ...
    const original = require('./patcher/good-target');
    const target = './patcher/good-target';
    const badPatcher = require('./patcher/bad-patcher');
    ...
    const goodTarget = require('./patcher/good-target');
  ...
  it('emits a patch event when patching was successful', function() {
    ...
    const original = require('./patcher/good-target');
    const target = './patcher/good-target';
    const goodPatcher = require('./patcher/good-patcher');
